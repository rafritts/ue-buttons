...
here. The SAME `height_at` drives the mesh, `landscape describe` sampling, `view(map)`, and
path ground-draping — so sampled heights agree with world traces by construction, no numpy
